...
class DataSynchronizationController:
    ...
    def update(self):
        ...
        _actuators_data = (
            self._db_service.execute(GET_UNTRANSMITTED_ACTUATORS_ORDERS),
        )
        # TODO THEN: Send data to the API
        schedule.every(10).minutes.do(
            self._api_service.api_put_greenhouse_send_data(
        ...
        _planted_at = (self._db_service.execute(),)
        _position = (self._db_service.execute(GET_PLANT_BY_POSITION),)
